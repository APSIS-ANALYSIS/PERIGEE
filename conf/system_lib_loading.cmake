...
elseif( $ENV{MACHINE_NAME} MATCHES "Riemann")
  message(STATUS "Mac pro Riemann")
  include(${CMAKE_CURRENT_LIST_DIR}/Riemann.cmake)
...
elseif( $ENV{MACHINE_NAME} MATCHES "qm-sun")
  message(STATUS "Sun's Qiming")
  include(${CMAKE_CURRENT_LIST_DIR}/Sun_qiming.cmake)
...
elseif( $ENV{MACHINE_NAME} MATCHES "M3C")
  message(STATUS "M3C")
  include(${CMAKE_CURRENT_LIST_DIR}/M3C_P360.cmake)
