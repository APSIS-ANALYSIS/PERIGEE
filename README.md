...
## Simulation Samples
The vortex-induced vibration of an elastic plate with high-Re number (Re $\approx$ 3 $\times$ 10^4) flow. The mesh consists of 18 million tetrahedral elements for the fluid and 0.7 million elements for the solid.
