...
// ElemBC_3D.hpp
//
// This is an instantiation of ElemBC for 3D problems.
// 
// The boundary is defined as a 3-1 = 2 dimensional manifold. In this
...
//                  3D domain. This will help define the outward normal
//                  vector
//
...
//
// global_cell[ebc_id] : the list of the surface 3D element indices
//                       that the 2D cell belongs to. 
//
...
{
  public:
    ElemBC_3D( const std::vector<int> &edge_idx,
