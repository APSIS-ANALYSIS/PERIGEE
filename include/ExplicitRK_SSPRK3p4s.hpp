#ifndef EXPLICITRK_SSPRK3P4S_HPP
#define EXPLICITRK_SSPRK3P4S_HPP
// ==================================================================
// Explicit Runge–Kutta method: strong-stability preserving method
// four-stage scheme with third-order accuracy on solution
//
...
class ExplicitRK_SSPRK3p4s final : public ITimeMethod_RungeKutta 
{
  public:
    ExplicitRK_SSPRK3p4s() : ITimeMethod_RungeKutta(4) 
    {
      // c_i values
      cc[0] = 0.0;
      cc[1] = 0.5;
      ...
      aa[1 * ss + 0] = 0.5; aa[1 * ss + 1] = 0.0; aa[1 * ss + 2] = 0.0; aa[1 * ss + 3] = 0.0;
      aa[2 * ss + 0] = 0.5; aa[2 * ss + 1] = 0.5; aa[2 * ss + 2] = 0.0; aa[2 * ss + 3] = 0.0;
      aa[3 * ss + 0] = 1.0 / 6.0; aa[3 * ss + 1] = 1.0 / 6.0; aa[3 * ss + 2] = 1.0 / 6.0; aa[3 * ss + 3] = 0.0;
    }
      
    ~ExplicitRK_SSPRK3p4s() override = default;
