#ifndef AGLOBAL_MESH_INFO_1PATCH_NURBS_3D_HPP
#define AGLOBAL_MESH_INFO_1PATCH_NURBS_3D_HPP
// ==================================================================
// AGlobal_Mesh_Info_1Patch_NURBS_3D.hpp
// This is an instantiation of glboal mesh info class which is suited
// for single patch geometry with NURBS 3D geometry
// ==================================================================
#include "IAGlobal_Mesh_Info.hpp"
#include "HDF5_PartReader.hpp"

class AGlobal_Mesh_Info_1Patch_NURBS_3D : public IAGlobal_Mesh_Info
{
  public:
    AGlobal_Mesh_Info_1Patch_NURBS_3D( const HDF5_PartReader * const &h5reader );
    virtual ~AGlobal_Mesh_Info_1Patch_NURBS_3D();
