#ifndef PGASSEM_V360_FEM_HPP
#define PGASSEM_V360_FEM_HPP
// ==================================================================
// PGAssem_v360_FEM.hpp
// 
// Parallel global assembly based on PETSc-3.6.0, using AIJ matrix
...
// conditions.
//
// Date Crated: Jan. 22 2017
// ==================================================================
#include "IPGAssem.hpp"
#include "PETSc_Tools.hpp"

class PGAssem_v360_FEM : public IPGAssem
{
  public:
    PGAssem_v360_FEM(
  ...
  private:
    ...
    // This funciton is copied from PGAssem_v360_NURBS class.
    // --------------------------------------------------------------
