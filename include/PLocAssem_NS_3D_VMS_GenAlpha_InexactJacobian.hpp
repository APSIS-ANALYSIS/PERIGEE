#ifndef PLOCASSEM_NS_3D_VMS_GENALPHA_INEXACTJACOBIAN_HPP
#define PLOCASSEM_NS_3D_VMS_GENALPHA_INEXACTJACOBIAN_HPP
// ==================================================================
// PLocAssem_NS_3D_VMS_GenAlpha_InexactJacobian.hpp
...
// 
// In this routine, we use inexact Jacobian for the Newton iteration.  
// The formula for the tangent matrix is given in the following paper:
//
...
class PLocAssem_NS_3D_VMS_GenAlpha_InexactJacobian : public IPLocAssem
{
  public:
    PLocAssem_NS_3D_VMS_GenAlpha_InexactJacobian(
    ...
    virtual ~PLocAssem_NS_3D_VMS_GenAlpha_InexactJacobian();
  ...
  private:
        ...
        double &fx, double &fy, double &fz) const
    {
      ...
      // Test 2: only pressure
      //fx = pi*cos(pi*x)*sin(pi*t)*sin(pi*y)*sin(pi*z);

      //fy = pi*cos(pi*y)*sin(pi*t)*sin(pi*x)*sin(pi*z);

      //fz = pi*cos(pi*z)*sin(pi*t)*sin(pi*x)*sin(pi*y);
    }
