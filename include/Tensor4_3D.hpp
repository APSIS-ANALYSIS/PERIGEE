...
// ==================================================================
// Tensor4_3D.hpp
// This is a 4th-order tensor in 3D. There are 3^4 = 81 double entries
// in this object, which are stored in an array. The indices are arranged
// in the following way:
//           ten[27i + 9j + 3k + l] = t_{ijkl}
// This mapping is inspired from the Matrix_3x3, where a matrix is mapped
// to an array as
//           mat[3i + j] = A_{ij}.
//
// The designed purpose is to ease the handling of stiffness tensor
// in solid mechanics.
//
// Author: Ju Liu
// Date: July 3rd 2016
...
class Tensor4_3D
{
  public:
    ...
    bool is_identical(const Tensor4_3D &source) const;
