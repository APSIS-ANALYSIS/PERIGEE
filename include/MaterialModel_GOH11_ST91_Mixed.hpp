#ifndef MATERIALMODEL_GOH11_ST91_MIXED_HPP
#define MATERIALMODEL_GOH11_ST91_MIXED_HPP
// ==================================================================
// MaterialModel_GOH11_ST91_Mixed.hpp
...
class MaterialModel_GOH11_ST91_Mixed : public IMaterialModel
{
  public:
    MaterialModel_GOH11_ST91_Mixed( 
    ...
    virtual ~MaterialModel_GOH11_ST91_Mixed();

    virtual void print_info() const;

    virtual std::string get_model_name() const
    {
      const std::string mname = "GOH11-ST91-Mixed";
      return mname;
    }
