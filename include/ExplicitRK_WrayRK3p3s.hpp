#ifndef EXPLICITRK_WRAYRK3P3S_HPP
#define EXPLICITRK_WRAYRK3P3S_HPP
// ==================================================================
// Explicit Runge–Kutta method: Wray’s method
...
class ExplicitRK_WrayRK3p3s final : public ITimeMethod_RungeKutta 
{
  public:
    ExplicitRK_WrayRK3p3s() : ITimeMethod_RungeKutta(3) 
    {
      // c_i values
      cc[0] = 0.0;
      cc[1] = 1.0 / 3.0;
      ...
      aa[1 * ss + 0] = 1.0 / 3.0; aa[1 * ss + 1] = 0.0; aa[1 * ss + 2] = 0.0;
      aa[2 * ss + 0] = -1.0;      aa[2 * ss + 1] = 2.0; aa[2 * ss + 2] = 0.0;
    }

    ~ExplicitRK_WrayRK3p3s() override = default;
