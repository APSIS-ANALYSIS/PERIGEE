#ifndef FEAELEMENT_NURBS_2D_DER2_HPP
#define FEAELEMENT_NURBS_2D_DER2_HPP
// ==================================================================
// FEAElement_NURBS_2D_der2.hpp
...
class FEAElement_NURBS_2D_der2 : public FEAElement
{
  public:
    FEAElement_NURBS_2D_der2( const int &in_eIndex,
    ...
    virtual ~FEAElement_NURBS_2D_der2();

    virtual int get_elemIndex() const {return elem_index;}
    virtual int get_elemDim() const {return 2;}

    // Type = 202: 2D NURBS H1 conforming basis with upto 2nd order 
    //             derivatives
    virtual int get_Type() const {return 202;}
