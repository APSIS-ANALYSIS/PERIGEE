#ifndef FEAELEMENT_NURBS_3D_DER2_HPP
#define FEAELEMENT_NURBS_3D_DER2_HPP
// ==================================================================
// FEAElement_NURBS_3D_der2.hpp
// This is an implementation of the element routine for 3D NURBS.
// The basis function are evaluated for the function and its 2nd 
// derivatives.
//
...
class FEAElement_NURBS_3D_der2 : public FEAElement
{
  public:
    FEAElement_NURBS_3D_der2( const int &in_sdeg, const int &in_tdeg,
        const int &in_udeg, const int &in_nquas, const int &in_nquat,
        const int &in_nquau );

    virtual ~FEAElement_NURBS_3D_der2();
