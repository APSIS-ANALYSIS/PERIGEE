#ifndef EXPLICITRK_FWRK1P2S_HPP
#define EXPLICITRK_FERK1P2S_HPP
// ==================================================================
// Explicit Runge–Kutta method: Forward Euler method
// Two-stage scheme with first-order accuracy on solution
//
...
class ExplicitRK_FERK1p2s final : public ITimeMethod_RungeKutta 
{
  public:
    ExplicitRK_FERK1p2s() : ITimeMethod_RungeKutta(2) 
    {
      // c_i values
      cc[0] = 0.0;
      cc[1] = 1.0; 
    ...
    ~ExplicitRK_FERK1p2s() override = default;
