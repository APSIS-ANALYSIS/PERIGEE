#ifndef MATERIALMODEL_GOH11_INCOMPRESSIBLE_MIXED_HPP
#define MATERIALMODEL_GOH11_INCOMPRESSIBLE_MIXED_HPP
// ==================================================================
// MaterialModel_GOH11_Incompressible_Mixed.hpp
...
//
// Reference: Layer-specific damage experiments and modeling of human 
// thoracic and abdominal aortas with non-atherosclerotic intimal thickening
//
// Date: Aug 12 2024
// Author: Xinhai Yue
// ==================================================================
...
class MaterialModel_GOH11_Incompressible_Mixed : public IMaterialModel
{
  public:
    MaterialModel_GOH11_Incompressible_Mixed( 
    ...
    virtual ~MaterialModel_GOH11_Incompressible_Mixed();

    virtual void print_info() const;

    virtual std::string get_model_name() const
    {
      const std::string mname = "GOH11-Incompressible-Mixed";
      return mname;
    }
