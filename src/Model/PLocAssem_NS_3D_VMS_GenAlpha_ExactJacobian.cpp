#include "PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian.hpp"

PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian(
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::print_info() const
{
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::Zero_Tangent_Residual()
{
  for(int ii=0; ii<vec_size; ++ii)
    Residual[ii] = 0.0;
  for(int ii=0; ii<vec_size*vec_size; ++ii)
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::Zero_Residual()
{
  for(int ii=0; ii<vec_size; ++ii)
    Residual[ii] = 0.0;
}
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::Assem_Estimate()
{
  for(int ii=0; ii<vec_size*vec_size; ++ii)
    Tangent[ii] = 1.0;
}
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::get_tau(
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::Assem_Residual(
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::Assem_Tangent_Residual(
    double time, double dt,
    const double * const &velo,
    const double * const &disp,
    const class FEAElement * const &element,
...
void PLocAssem_NS_3D_VMS_GenAlpha_ExactJacobian::Assem_Mass_Residual(
    const double * const &disp,
    const class FEAElement * const &element,
    const double * const &eleCtrlPts_x,
    const double * const &eleCtrlPts_y,
