  ...
  switch (ss) 
  {
    ...
    case 3:
      ...
      else if (mm == 3)
      {
        ...
        // cc[0] = 0.0; cc[1] = 1.0/2.0; cc[2] = 1.0;
        // aa[0][0] = 0.0;
        // aa[1][0] = 1.0/2.0;
        ...
        // cc[0] = 0.0; cc[1] = 1.0/3.0; cc[2] = 2.0/3.0;
        // aa[0][0] = 0.0;
        // aa[1][0] = 1.0/3.0;
        // aa[2][0] = 0.0; aa[2][1] = 2.0/3.0;
        // bb[0] = 1.0/4.0; bb[1] = 0.0; bb[2] = 3.0/4.0;

        // Ralston's third-order method √
        // cc[0] = 0.0; cc[1] = 1.0/2.0; cc[2] = 3.0/4.0;
        // aa[0][0] = 0.0;
        // aa[1][0] = 1.0/2.0;
        // aa[2][0] = 0.0; aa[2][1] = 3.0/4.0;
        // bb[0] = 2.0/9.0; bb[1] = 1.0/3.0; bb[2] = 4.0/9.0;

        // TVD SSP RK3 √
        cc[0] = 0.0; cc[1] = 1.0; cc[2] = 1.0/2.0;
        aa[0][0] = 0.0;
        aa[1][0] = 1.0;
    ...
    case 4:
      ...
      { 
        // Classic RK4
        // cc[0] = 0.0; cc[1] = 1.0/2.0; cc[2] = 1.0/2.0; cc[3] = 1.0; 
        // aa[0][0] = 0.0; 
        // aa[1][0] = 1.0/2.0;
        // aa[2][0] = 0.0; aa[2][1] = 1.0/2.0;
        // aa[3][0] = 0.0; aa[3][1] = 0.0; aa[3][2] = 1.0;
        // bb[0] = 1.0/6.0; bb[1] = 1.0/3.0; bb[2] = 1.0/3.0; bb[3] = 1.0/6.0;

        // 3/8-rule fourth-order method
        cc[0] = 0.0; cc[1] = 1.0/3.0; cc[2] = 2.0/3.0; cc[3] = 1.0; 
        aa[0][0] = 0.0; 
        aa[1][0] = 1.0/3.0;
        aa[2][0] = -1.0/3.0; aa[2][1] = 1.0;
        aa[3][0] = 1.0; aa[3][1] = -1.0; aa[3][2] = 1.0;
        bb[0] = 1.0/8.0; bb[1] = 3.0/8.0; bb[2] = 3.0/8.0; bb[3] = 1.0/8.0;  

        // Ralston's fourth-order method
        // const double beta = std::sqrt(5);
        // cc[0] = 0.0; cc[1] = 2.0/5.0; cc[2] = (14.0-3.0*beta)/16.0; cc[3] = 1.0; 
        // aa[0][0] = 0.0; 
        // aa[1][0] = 2.0/5.0;
        // aa[2][0] = (-2889.0 + 1428.0*beta)/1024.0; aa[2][1] = (3785.0-1620.0*beta)/1024.0;
        // aa[3][0] = (-3365.0 + 2094.0*beta)/6040.0; aa[3][1] = (-975.0-3046.0*beta)/2552.0; aa[3][2] = (467040.0 + 203968.0*beta)/240845.0;
        // bb[0] = (263.0 + 24.0*beta)/1812.0; bb[1] = (125.0 - 1000.0*beta)/3828.0; bb[2] = (3426304.0 + 1661952.0*beta)/5924787.0; bb[3] = (30.0 - 4.0*beta)/123.0;          
      }
      break; 
    case 5:
      if (mm == 3) 
