...
Vector_3 FEAElement_Triangle3_membrane::get_2d_normal_out( const int &quaindex, 
    double &area ) const
{
  ASSERT(quaindex>=0 && quaindex < numQuapts, "FEAElement_Tet4::get_2d_normal_out function error.\n" );
  area = detJac;
...
{
  ASSERT( quaindex >= 0 && quaindex < numQuapts, "FEAElement_Tet4::get_rotationMatrix function error.\n" );
  return Q;
}
