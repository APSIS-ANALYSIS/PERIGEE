#include "FEAElement_NURBS_3D_der1_lap_v3.hpp"

FEAElement_NURBS_3D_der1_lap_v3::FEAElement_NURBS_3D_der1_lap_v3(const int &in_eIndex,
...
FEAElement_NURBS_3D_der1_lap_v3::~FEAElement_NURBS_3D_der1_lap_v3()
{
  clearBasisCache();
}

void FEAElement_NURBS_3D_der1_lap_v3::clearBasisCache()
{
  if( is_sNonzero )
  {
    delete [] R; 
...
void FEAElement_NURBS_3D_der1_lap_v3::buildBasis(
...
void FEAElement_NURBS_3D_der1_lap_v3::get_R(const int &quaindex, 
...
void FEAElement_NURBS_3D_der1_lap_v3::get_gradR(const int &quaindex, 
...
void FEAElement_NURBS_3D_der1_lap_v3::get_3D_R_gradR_LaplacianR(
...
void FEAElement_NURBS_3D_der1_lap_v3::print() const
{
  SYS_T::commPrint("NURBS_3D_der1_lap_v3: ");
...
double FEAElement_NURBS_3D_der1_lap_v3::get_memory_usage() const
{
  unsigned int double_size = 0; unsigned int int_size = 3;
  double_size = nLocBas * numQuapts * 7 + numQuapts;

  return (double) double_size * 8.0 + (double) int_size * 4.0;
}

void FEAElement_NURBS_3D_der1_lap_v3::BuildShape_atQua(
