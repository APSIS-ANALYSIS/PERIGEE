...
FEAElement_NURBS_3D_der1_lap_vms::FEAElement_NURBS_3D_der1_lap_vms(const int &in_eIndex,
...
FEAElement_NURBS_3D_der1_lap_vms::~FEAElement_NURBS_3D_der1_lap_vms()
{
  clearBasisCache();
}

void FEAElement_NURBS_3D_der1_lap_vms::clearBasisCache()
{
  if( is_sNonzero )
  {
    delete [] R; 
...
void FEAElement_NURBS_3D_der1_lap_vms::buildBasis(
...
void FEAElement_NURBS_3D_der1_lap_vms::get_R(const int &quaindex, 
...
void FEAElement_NURBS_3D_der1_lap_vms::get_gradR(const int &quaindex, 
...
void FEAElement_NURBS_3D_der1_lap_vms::get_3D_R_gradR_LaplacianR(
...
void FEAElement_NURBS_3D_der1_lap_vms::get_invJacobian(const int &quaindex,
...
void FEAElement_NURBS_3D_der1_lap_vms::print() const
{
  SYS_T::commPrint("NURBS_3D_der1_vms: ");
...
double FEAElement_NURBS_3D_der1_lap_vms::get_memory_usage() const
{
  unsigned int int_size = 3;
  unsigned int double_size = nLocBas * numQuapts * 7 + numQuapts * 10;

  return (double) double_size * 8.0 + (double) int_size * 4.0;
}

void FEAElement_NURBS_3D_der1_lap_vms::BuildShape_atQua(
    ...
    )
{
  ...
  ds_dx_qua[quaindex] = ds_dx * invhx;
  ds_dy_qua[quaindex] = ds_dy * invhx;
  ds_dz_qua[quaindex] = ds_dz * invhx;
  dt_dx_qua[quaindex] = dt_dx * invhy;
  dt_dy_qua[quaindex] = dt_dy * invhy;
  dt_dz_qua[quaindex] = dt_dz * invhy;
  du_dx_qua[quaindex] = du_dx * invhz;
  du_dy_qua[quaindex] = du_dy * invhz;
  du_dz_qua[quaindex] = du_dz * invhz;
