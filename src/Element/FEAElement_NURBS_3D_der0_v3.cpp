...
FEAElement_NURBS_3D_der0_v3::FEAElement_NURBS_3D_der0_v3(const int &in_eIndex,
    ...
    const ALocal_IEN * const &locIEN)
{
  ...
  // memory layout of basis function vectors R:
...
FEAElement_NURBS_3D_der0_v3::~FEAElement_NURBS_3D_der0_v3()
{
  clearBasisCache();
}

void FEAElement_NURBS_3D_der0_v3::clearBasisCache()
{
  if(is_sNonzero)
  {
    delete [] R; 
...
void FEAElement_NURBS_3D_der0_v3::buildBasis(
...
inline void FEAElement_NURBS_3D_der0_v3::get_R(const int &quaindex, 
...
inline double FEAElement_NURBS_3D_der0_v3::get_detJac( const int &quaindex ) const
{
  return detJac[quaindex];
}

void FEAElement_NURBS_3D_der0_v3::print() const
{
  SYS_T::commPrint("NURBS_3D_der0_v3: ");
  SYS_T::commPrint("3-Dimensional NURBS shape function. \n");
  SYS_T::commPrint("Note: Jacobian matrix is not evaluated. \n");
}

double FEAElement_NURBS_3D_der0_v3::get_memory_usage() const
{
...
void FEAElement_NURBS_3D_der0_v3::BuildShape_atQua(
