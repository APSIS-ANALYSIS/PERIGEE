...
Mesh_NURBS_1ofnPatch_3D::Mesh_NURBS_1ofnPatch_3D( 
    ...
    const std::vector<double> &in_uknot, const int &in_pindex,
    const int &in_elem_start, const int &in_func_start )
: patch_index(in_pindex), elem_start(in_elem_start),
  func_start(in_func_start)
{
...
Mesh_NURBS_1ofnPatch_3D::Mesh_NURBS_1ofnPatch_3D( 
    const int &in_s_degree, const int &in_t_degree,
  ...
  func_start(in_func_start)
{
  ...
  std::cout<<"--- Mesh_NURBS_1ofnPatch_3D generated.";
...
Mesh_NURBS_1ofnPatch_3D::~Mesh_NURBS_1ofnPatch_3D()
{
  //std::cout<<"-- Mesh_NURBS_1ofnPatch_3D patch"<<patch_index<<" deleted. \n";
}

void Mesh_NURBS_1ofnPatch_3D::get_elem_index( const s_int &ee, 
...
double Mesh_NURBS_1ofnPatch_3D::get_hx( s_int ee ) const
{
  s_int ex, ey, ez;
...
double Mesh_NURBS_1ofnPatch_3D::get_hy( s_int ee) const
{
  s_int ex, ey, ez;
  get_elem_index(ee, ex, ey, ez);
...
double Mesh_NURBS_1ofnPatch_3D::get_hz( s_int ee) const
{
  s_int ex, ey, ez;
  get_elem_index(ee, ex, ey, ez);
...
void Mesh_NURBS_1ofnPatch_3D::print_mesh_info() const
{
  std::cout<<std::endl;
  std::cout<<"====== Mesh_NURBS_1ofnPatch_3D ======"<<std::endl;
