...
void Mesh_NURBS_1ofnPatch_3D::get_elem_index( const int &ee, 
...
double Mesh_NURBS_1ofnPatch_3D::get_hx( int ee ) const
{
  int ex, ey, ez;
...
double Mesh_NURBS_1ofnPatch_3D::get_hy( int ee) const
{
  int ex, ey, ez;
  get_elem_index(ee, ex, ey, ez);
...
double Mesh_NURBS_1ofnPatch_3D::get_hz( int ee) const
{
  int ex, ey, ez;
  get_elem_index(ee, ex, ey, ez);
