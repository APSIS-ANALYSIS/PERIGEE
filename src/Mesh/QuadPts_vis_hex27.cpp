...
QuadPts_vis_hex27::QuadPts_vis_hex27()
{
  ...
  qw[0 ] = 0.5; qw[1 ] = 0.5; qw[2 ] = 0.5; 
  qw[3 ] = 0.5; qw[4 ] = 0.5; qw[5 ] = 0.5; 
  qw[6 ] = 0.5; qw[7 ] = 0.5; qw[8 ] = 0.5; 
  qw[9 ] = 0.5; qw[10] = 0.5; qw[11] = 0.5;
  qw[12] = 0.5; qw[13] = 0.5; qw[14] = 0.5; 
  qw[15] = 0.5; qw[16] = 0.5; qw[17] = 0.5;
  qw[18] = 0.5; qw[19] = 0.5; qw[20] = 0.5; 
  qw[21] = 0.5; qw[22] = 0.5; qw[23] = 0.5;
