#include "VisDataPrep_3DTNSK.hpp"

VisDataPrep_3DTNSK::VisDataPrep_3DTNSK()
{
  arrayCompSize = 5;
...
void VisDataPrep_3DTNSK::get_pointArray(
    ...
    double ** &pointArrays ) const
{
  ...
  for(int ii=0; ii<ntotal; ++ii)
  {
    ...
    pointArrays[2][ii]     = pvsolu.get_locsol(ii*input_dof+4);
    pointArrays[3][ii]     = pvsolu.get_locsol(ii*input_dof+5);
  }
