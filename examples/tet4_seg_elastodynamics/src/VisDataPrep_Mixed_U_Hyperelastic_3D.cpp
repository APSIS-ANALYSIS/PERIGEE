...
VisDataPrep_Mixed_U_Hyperelastic_3D::VisDataPrep_Mixed_U_Hyperelastic_3D( const bool &is_ref )
{
  if(is_ref)
  {
    arrayCompSize = 3;
  ...
  else
  {
    ...
    arraySizes.push_back(1);
    arrayNames.push_back("von Mises stress");
    arraySizes.push_back(1);
    //arrayNames.push_back("Cauchy-z");
    //arraySizes.push_back(3);
...
VisDataPrep_Mixed_U_Hyperelastic_3D::~VisDataPrep_Mixed_U_Hyperelastic_3D()
{}


void VisDataPrep_Mixed_U_Hyperelastic_3D::get_pointArray(
