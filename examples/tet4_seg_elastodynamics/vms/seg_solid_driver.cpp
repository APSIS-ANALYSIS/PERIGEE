...
int main(int argc, char *argv[])
{
  ...
  SYS_T::GetOptionReal("-ll_rtol", ll_rtol);
  SYS_T::GetOptionReal("-ll_atol", ll_atol);
  SYS_T::GetOptionReal("-ll_dtol", ll_dtol);
  SYS_T::GetOptionInt("-ll_maxits", ll_maxits);
  ...
  SYS_T::cmdPrint("-ll_rtol:", ll_rtol);
  SYS_T::cmdPrint("-ll_atol:", ll_atol);
  SYS_T::cmdPrint("-ll_dtol:", ll_dtol);
