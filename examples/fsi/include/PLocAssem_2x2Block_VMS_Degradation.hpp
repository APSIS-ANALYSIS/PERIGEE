#ifndef PLOCASSEM_2X2BLOCK_VMS_DEGRADATION_HPP
#define PLOCASSEM_2X2BLOCK_VMS_DEGRADATION_HPP
// ============================================================================
// PLocAssem_2x2Block_VMS_Degradation.hpp
//
...
class PLocAssem_2x2Block_VMS_Degradation : public IPLocAssem_2x2Block
{
  public:
    PLocAssem_2x2Block_VMS_Degradation(
  ...
  private:
    ...
    typedef Vector_3 ( PLocAssem_2x2Block_VMS_Degradation::*locassem_2x2block_vms_comp_ela_fem_funs )( 
