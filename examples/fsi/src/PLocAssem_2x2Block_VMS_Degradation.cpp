...
PLocAssem_2x2Block_VMS_Degradation::PLocAssem_2x2Block_VMS_Degradation(
...
{
  deg_center.x() = in_deg_center_x;
  deg_center.y() = in_deg_center_y;
  deg_center.z() = in_deg_center_z;
...
void PLocAssem_2x2Block_VMS_Degradation::print_info() const
{
...
std::array<double, 2> PLocAssem_2x2Block_VMS_Degradation::get_tau( 
...
void PLocAssem_2x2Block_VMS_Degradation::Zero_Tangent_Residual()
{
...
void PLocAssem_2x2Block_VMS_Degradation::Zero_Residual()
{
  for(int ii=0; ii<vec_size_0; ++ii) Residual0[ii] = 0.0;
  for(int ii=0; ii<vec_size_1; ++ii) Residual1[ii] = 0.0;
}
...
void PLocAssem_2x2Block_VMS_Degradation::Assem_Estimate()
{
...
void PLocAssem_2x2Block_VMS_Degradation::Assem_Residual(
...
void PLocAssem_2x2Block_VMS_Degradation::Assem_Tangent_Residual(
    const double &time, const double &dt,
    const double * const &dot_disp,
    const double * const &dot_velo,
    const double * const &dot_pres,
...
void PLocAssem_2x2Block_VMS_Degradation::Assem_Mass_Residual(
    const double * const &disp,
    const double * const &velo,
    const double * const &pres,
    FEAElement * const &element,
...
void PLocAssem_2x2Block_VMS_Degradation::Assem_Residual_EBC(
    const int &ebc_id,
    const double &time, const double &dt,
    FEAElement * const &element,
    const double * const &eleCtrlPts_x,
...
void PLocAssem_2x2Block_VMS_Degradation::Assem_Residual_Interior_Wall_EBC(
    const double &time,
    const double * const &pres,
    FEAElement * const &element,
    const double * const &eleCtrlPts_x,
...
std::vector<Tensor2_3D> PLocAssem_2x2Block_VMS_Degradation::get_Wall_CauchyStress(
    const double * const &disp,
    const double * const &pres,
    FEAElement * const &element,
    const double * const &eleCtrlPts_x,
