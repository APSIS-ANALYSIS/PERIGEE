...
{
  double errorH1 = 0.0;
  double * R = new double[quad->get_num_quadPts()]();
  double * R_dx = new double[quad->get_num_quadPts()]();
  double * R_dy = new double[quad->get_num_quadPts()]();
  double * R_dz = new double[quad->get_num_quadPts()]();
