...
int main(int argc, char *argv[])
{
  ...
  else if( GMIptr->get_elemType() == FEType::Hex8 )
  {
    ...
    elementv = new FEAElement_Hex8( nqp_vol_1D * nqp_vol_1D * nqp_sur_1D ); // elem type Hex8
  ...
  else if( GMIptr->get_elemType() == FEType::Hex27 )
  {
    ...
    elementv = new FEAElement_Hex27( nqp_vol_1D * nqp_vol_1D * nqp_sur_1D ); // elem type Hex27
