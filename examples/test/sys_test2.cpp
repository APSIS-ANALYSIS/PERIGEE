...
int main(int argc, char *argv[])
{
  ...
  std::string sur_f_file_wall("./lumen_wall_vol.vtu");
  std::string sur_f_file_in_base( "./lumen_inlet_vol_" );
  std::string sur_f_file_out_base("./lumen_outlet_vol_");

  std::string sur_s_file_interior_wall("./tissue_interior_wall_vol.vtu");

  std::string sur_s_file_wall("./tissue_wall_vol.vtu");
  ...
  {
    sur_f_file_in[ii] = SYS_T::gen_capfile_name( sur_f_file_in_base, ii, ".vtu" );
    sur_s_file_in[ii] = SYS_T::gen_capfile_name( sur_s_file_in_base, ii, ".vtu" );
  ...
  {
    sur_f_file_out[ii] = SYS_T::gen_capfile_name( sur_f_file_out_base, ii, ".vtu" );
    sur_s_file_out[ii] = SYS_T::gen_capfile_name( sur_s_file_out_base, ii, ".vtu" );
  ...
  {  
    std::cout<<sur_f_file_in[ii]<<" the num of surface eLement:"<<InFBC->get_num_cell(ii)<<std::endl;
  ...
  {  
    std::cout<<sur_f_file_out[ii]<<" the num of surface eLement:"<<ebc->get_num_cell(ii)<<std::endl;
