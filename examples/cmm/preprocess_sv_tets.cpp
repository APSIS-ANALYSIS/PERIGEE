...
int main( int argc, char * argv[] )
{
  ...
  if(elemType == 501)
  {
    ...
    NBC_list[1] = new NodalBC_3D_vtp( sur_file_in, inlet_outvec, sur_file_wall, sur_file_out, outlet_outvec, 1, 0, nFunc );
    NBC_list[2] = new NodalBC_3D_vtp( sur_file_in, inlet_outvec, sur_file_wall, sur_file_out, outlet_outvec, 1, 1, nFunc );
    NBC_list[3] = new NodalBC_3D_vtp( sur_file_in, inlet_outvec, sur_file_wall, sur_file_out, outlet_outvec, 1, 2, nFunc );
  }
  else
  {
