...
namespace SOLID_INIT
{
  ...
  inline void apply_initial_dirichlet_bc( PGAssem_Solid_FEM * const gloAssem,
      const double &time,
  ...
  {
    gloAssem->Apply_Dirichlet_BC( time, dot_disp, dot_velo, disp, velo );
  }
      ...
      const bool is_restart )
  {
    ...
    apply_initial_dirichlet_bc( gloAssem, initial_time,
