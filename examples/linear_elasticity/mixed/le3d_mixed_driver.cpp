...
int main(int argc, char *argv[])
{
  ...
  IPLocAssem * locAssem_ptr = new PLocAssem_Mixed_LinearElastic_3D_Static(
  ...
  PDNSolution * disp = new PDNSolution_Mixed_LinearElastic_3D(
      pNode, locAssem_ptr, fNode, 0);

  PDNSolution * update = new PDNSolution_Mixed_LinearElastic_3D(
      pNode, locAssem_ptr, fNode, 0 );
  ...
  SYS_T::commPrint("\n===> Static solution obtained, clean memory.\n");
  ...
  delete locnbc; delete locebc; delete lsolver;
  PetscFinalize();
  return EXIT_SUCCESS;
}
