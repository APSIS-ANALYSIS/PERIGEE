...
VTK_Writer_LE_Tet4::VTK_Writer_LE_Tet4( const int &in_nelem,
...
VTK_Writer_LE_Tet4::~VTK_Writer_LE_Tet4()
{
  VEC_T::clean(epart_map);
}


void VTK_Writer_LE_Tet4::writeOutput(
...
void VTK_Writer_LE_Tet4::writeOutput_ref(
    const FEANode * const &fnode_ptr,
    const ALocal_IEN * const &lien_ptr,
    const ALocal_Elem * const &lelem_ptr,
    const IVisDataPrep * const &vdata_ptr,
