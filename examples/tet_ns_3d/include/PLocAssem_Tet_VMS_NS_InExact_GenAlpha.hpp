#ifndef PLOCASSEM_TET_VMS_NS_INEXACT_GENALPHA_HPP
#define PLOCASSEM_TET_VMS_NS_INEXACT_GENALPHA_HPP
// ==================================================================
// PLocAssem_Tet_VMS_NS_InExact_GenAlpha.hpp
// 
// Parallel Local Assembly routine for VMS and Gen-alpha based NS
// solver using inexact tangent matrix.
//
// Date: June 10 2020
// ==================================================================
...
class PLocAssem_Tet_VMS_NS_InExact_GenAlpha : public IPLocAssem
{
  public:
    PLocAssem_Tet_VMS_NS_InExact_GenAlpha(
    ...
    virtual ~PLocAssem_Tet_VMS_NS_InExact_GenAlpha();
  ...
  private:
    ...
    typedef void ( PLocAssem_Tet_VMS_NS_InExact_GenAlpha::*locassem_tet_vms_ns_funs )( const double &x, const double &y, const double &z,
        const double &t, const double &nx, const double &ny,
        const double &nz, double &gx, double &gy, double &gz ) const;
