...
n_modes = 10;                       % num Fourier modes (including steady 0th mode)
...
h_s   = 0.03; % 0.06;                                       % wall thickness (cm)
E_s   = 9863400; % 1.0e4 * 13.3^2 / (h_s * (0.2 * R)^(-0.4));  % wall Young's modulus (dyn/cm2)
